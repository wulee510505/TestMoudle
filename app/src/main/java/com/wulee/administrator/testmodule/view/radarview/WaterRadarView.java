package com.wulee.administrator.testmodule.view.radarview;
...
public class WaterRadarView extends View {
    ...
    private int   mCircleColor = Color.GREEN; //最内层圈圈的颜色，下面依次
    ...
    public WaterRadarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        screenWidth = SystemUtils.getScreenWidthAndHeight(context)[0];
        initView();
    }
