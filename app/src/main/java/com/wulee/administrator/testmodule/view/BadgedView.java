...
import com.wulee.administrator.testmodule.view.badge.BaseBadge;
...
public class BadgedView extends ViewGroup {
    ...
    public BadgedView(Context context, AttributeSet attrs) {
        ...
        badgeColor = a.getColor(R.styleable.BadgedImageView_badgeColor, getResources().getColor(R.color.default_badge_color));
        badgeTextColor = a.getColor(R.styleable.BadgedImageView_badgeTextColor, getResources().getColor(R.color.default_badge_text_color));
